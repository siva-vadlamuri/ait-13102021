// ECMA --> European Computers Manfactures Assiosiation
// ES6/ECMA2015
...
// console.log(firstProduct.id, firstProduct.image, firstProduct.price);
// console.log(firstProduct.rating.rate);
const {
  id,
  image,
  price,
...
console.log(id, image, price, count);
